                    ...
                    <div class="permission-group">
                        ...
                        <div class="permission-items">
                            <?php foreach($items as $permission) { ?>
                                <label><input type="checkbox" name="permissions[]" value="<?= $permission['id'] ?>"><?= $permission['permission_name'] ?></label>
                            <?php } ?>
                        </div>
                    </div>
                <?php } ?>
            </div>
            <button type="submit" class="theme-btn mt-5">Save Role</button>
        </form>
    </div>
</div>
