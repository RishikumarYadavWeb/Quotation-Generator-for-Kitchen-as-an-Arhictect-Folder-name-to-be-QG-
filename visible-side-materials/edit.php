...
if(!$row){
    die('Visible Side Material Not Found');
}
...
<div class="page-card">
    ...
    <div class="page-header mb-4">
        <div>
            <h1 class="page-title">Edit Visible Side Material</h1>
            <p class="page-subtitle">
                Update visible side material details
            </p>
        </div>
    </div>
    ...
    <form method="POST" action="update.php">
        ...
        <div class="mb-3">
            <label>Visible Side Category</label>
