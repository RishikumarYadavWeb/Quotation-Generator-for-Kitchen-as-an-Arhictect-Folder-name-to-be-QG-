...
if(!$row){
    die('Visible Panel Material Not Found');
}
...
<div class="page-card">
    ...
    <div class="page-header mb-4">
        <div>
            <h1 class="page-title">Edit Visible Panel Material</h1>
            <p class="page-subtitle">
                Update visible panel material details
            </p>
        </div>
    </div>
    ...
    <form method="POST" action="update.php">
        ...
        <div class="mb-3">
            <label>Visible Panel Category</label>
        ...
        <div class="mb-3">
            ...
            <input
                ...
                name="material_name"
                class="modern-input"
                value="<?= htmlspecialchars($row['material_name']) ?>"
                required
            >
        </div>
